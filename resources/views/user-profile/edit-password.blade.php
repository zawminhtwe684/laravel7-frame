@extends('layouts.app')
@section('title')Edit Password Page @endsection
@section('content')
    <x-bread-crumb>
            ...
            <div class="card-body">
                <form action="{{route('profile.changePassword')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        @error('new_password')
                            <small class="text-weight-bold text-danger">{{ $messae }}</small>
                        @enderror
                    </div>
                    <div class="form-group">
                        <label for="repeat">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="custom-control custom-switch">
                            ...
                            <label class="custom-control-label mr-1" for="customSwitch2">I'm Sure</label>
                        </div>
