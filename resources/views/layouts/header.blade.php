            ...
            <div class="p-2 bg-primary d-flex justify-content-between align-items-center rounded">
                ...
                <div class="dropdown">
                    <button class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{isset(Auth::user()->photo)?asset('storage/profile/'.Auth::user()->photo) : asset('dashboard/img/default profile photo.jpg')}}" class="user-img shadow-sm" alt=""> {{ Auth::user()->name}} <!-- ‌နာမည်ပဲထုတ်ပြချင်ရင်သုံးတယ် -->
                    </button>
